...
from src.infrastructure.persistence.models.print_task_model import PrintTaskModel
...
class PrintTaskRepository:
    ...
    def _to_domain(self, model: PrintTaskModel) -> PrintTask:
        ...
        return PrintTask(
            ...
            estimated_time=(
                timedelta(seconds=model.estimated_time_seconds)
                if model.estimated_time_seconds
                else None
            ),
